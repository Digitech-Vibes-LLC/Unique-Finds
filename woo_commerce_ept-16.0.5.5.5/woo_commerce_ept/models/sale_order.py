...
class SaleOrder(models.Model):
    ...
    def create_woo_refund(self, refunds_data, woo_status, order):
        ...
        if not existing_refunds and woo_status == "refunded":
            ...
            if self.woo_instance_id.woo_credit_note_register_payment:
    ...
    def woo_prepare_credit_note_payment_dict(self, woo_instance, new_move):
        return {
            'journal_id': woo_instance.woo_credit_note_payment_journal.id if woo_instance.woo_credit_note_payment_journal.id else self.auto_workflow_process_id.journal_id.id,
